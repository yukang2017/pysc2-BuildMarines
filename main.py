...
flags.DEFINE_integer("max_agent_steps", 2000, "Total agent steps.")
...
#      replay_buffer = []
      for replay_buffer, num_echos, is_done in run_loop(FLAGS, [agent], env, MAX_AGENT_STEPS):
        #print('isdone = ', is_done)
        #print('recorder = ', recorder)

        if FLAGS.training and num_echos:
...
def _main(unused_argv):
  ...
  for i in range(PARALLEL):
    ...
    #agent.build_model(i > 0, DEVICE[i % len(DEVICE)], FLAGS.net)#g
    agents.append(agent)
